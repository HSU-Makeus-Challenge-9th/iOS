...
class CalendarViewModel :ObservableObject{
    ...
    var calendar: Calendar // 날짜 계산을 위한 Calendar 객체
    
    @Published var canSelectDate: Bool = false
    @Published var weekDates: [CalendarDay] = []
    ...
    public func bindTheaterSelection(_ publisher: Published<Bool>.Publisher){
        publisher
//            .receive(on: Runloop.main)
    ...
    public func SelectDate(_ date: Date){
        guard canSelectDate else { return }
        selectedDate = date
    }
